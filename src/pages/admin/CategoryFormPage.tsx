...
export function CategoryFormPage() {
  ...
  return (
    <>
      <Seo
        title={`${isEdit ? "Editar" : "Nueva"} categoría | Admin`}
        description="Formulario de categoría"
        noindex
      />
      <AdminLayout title={isEdit ? "Editar categoría" : "Nueva categoría"}>
        {loading ? (
          ...
          <form
            ...
            className="max-w-xl rounded-xl border border-black/5 bg-white p-6"
          >
            {error && (
              <p className="mb-4 rounded-lg bg-rojo/10 px-3 py-2 text-sm text-rojo">
                {error}
              </p>
            )}
